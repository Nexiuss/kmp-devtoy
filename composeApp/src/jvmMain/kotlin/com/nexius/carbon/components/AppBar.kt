            ...
            BottomAppBar(
                actions = {
                    IconButton(onClick = { /* do something */ }) {
                        Icon(loadIcon("check.png"), contentDescription = "Localized description")
                    }
                    IconButton(onClick = { /* do something */ }) {
                        Icon(
                            loadIcon("edit.png"),
                ...
                floatingActionButton = {
                    FloatingActionButton(
                        ...
                        Icon(Icons.Filled.Add.toVector(), "Localized description")
                    }
                }
            )
        },
        ...
        topBar = {
            CenterAlignedTopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = { /* do something */ }) {
                        Icon(
                            Icons.Filled.ArrowBack.toVector(),
                            contentDescription = "Localized description"
                        )
                    }
                },

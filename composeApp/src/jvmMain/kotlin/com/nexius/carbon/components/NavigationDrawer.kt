            ...
            ModalDrawerSheet {
                Column(
                    ...
                    NavigationDrawerItem(
                        label = { Text("Settings") },
                        selected = false,
                        icon = { Icon(Icons.Outlined.Settings.toVector(), contentDescription = null) },
                    ...
                    NavigationDrawerItem(
                        ...
                        selected = false,
                        icon = { Icon(Icons.Outlined.Help.toVector(), contentDescription = null) },
                        onClick = { /* Handle click */ },
                    )
                    Spacer(Modifier.height(12.dp))
                }
                ...
                TopAppBar(
                    ...
                    navigationIcon = {
                        IconButton(onClick = {
                            ...
                            Icon(Icons.Default.Menu.toVector(), contentDescription = "Menu")
                        }
                    }
                )
            }

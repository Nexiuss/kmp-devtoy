...
fun MinimalDropdownMenu() {
    ...
    Box(
        ...
        IconButton(onClick = { expanded = !expanded }) {
            Icon(Icons.Default.MoreVert.toVector(), contentDescription = "More options")
        }
        DropdownMenu(
            expanded = expanded,
...
fun DropdownMenuWithDetails() {
    ...
    Box(
        ...
        DropdownMenu(
            ...
            DropdownMenuItem(
                text = { Text("Profile") },
                leadingIcon = { Icon(Icons.Outlined.Person.toVector(), contentDescription = null) },
                onClick = { /* Do something... */ }
            )
            DropdownMenuItem(
                text = { Text("Settings") },
                leadingIcon = { Icon(Icons.Outlined.Settings.toVector(), contentDescription = null) },
                onClick = { /* Do something... */ }
            )
            ...
            DropdownMenuItem(
                ...
                leadingIcon = { Icon(Icons.Outlined.Feedback.toVector(), contentDescription = null) },
                trailingIcon = { Icon(Icons.Outlined.Send.toVector(), contentDescription = null) },
                onClick = { /* Do something... */ }
            )
            ...
            DropdownMenuItem(
                text = { Text("About") },
                leadingIcon = { Icon(Icons.Outlined.Info.toVector(), contentDescription = null) },
                onClick = { /* Do something... */ }
            )
            DropdownMenuItem(
                text = { Text("Help") },
                leadingIcon = { Icon(Icons.Outlined.Help.toVector(), contentDescription = null) },
                trailingIcon = { Icon(Icons.Outlined.OpenInNew.toVector(), contentDescription = null) },
                onClick = { /* Do something... */ }
            )
        }
    }
...
fun DropdownFilter(modifier: Modifier = Modifier) {
    Row(
        ...
        Icon(Icons.Default.Tune.toVector(), "Filters")
...
fun DropdownFilterChip(modifier: Modifier = Modifier) {
    ...
    Box(modifier) {
        FilterChip(
            ...
            leadingIcon = { if (selectedChipText != null) Icon(Icons.Default.Check.toVector(), null) },
            trailingIcon = { Icon(Icons.Default.ArrowDropDown.toVector(), null) },
        )
        DropdownMenu(
            ...
            DropdownMenuItem(
                text = { Text("Running") },
                leadingIcon = { Icon(Icons.Default.DirectionsRun.toVector(), null) },
                onClick = {
                    selectedChipText =
            ...
            DropdownMenuItem(
                text = { Text("Walking") },
                leadingIcon = { Icon(Icons.Default.DirectionsWalk.toVector(), null) },
                onClick = {
                    selectedChipText =
            ...
            DropdownMenuItem(
                text = { Text("Hiking") },
                leadingIcon = { Icon(Icons.Default.Hiking.toVector(), null) },
                onClick = {
                    selectedChipText =
            ...
            DropdownMenuItem(
                text = { Text("Cycling") },
                leadingIcon = { Icon(Icons.Default.DirectionsBike.toVector(), null) },
                onClick = {
                    selectedChipText =

...
fun Example(onClick: () -> Unit) {
    FloatingActionButton(
        ...
        Icon(Icons.Filled.Add.toVector(), "Floating action button.")
    }
}
...
fun ExtendedExample(onClick: () -> Unit) {
    ExtendedFloatingActionButton(
        onClick = { onClick() },
        icon = { Icon(Icons.Filled.Edit.toVector(), "Extended floating action button.") },
...
fun SmallExample(onClick: () -> Unit) {
    SmallFloatingActionButton(
        ...
        Icon(Icons.Filled.Add.toVector(), "Small floating action button.")
    }
}
...
fun LargeExample(onClick: () -> Unit) {
    LargeFloatingActionButton(
        ...
        Icon(Icons.Filled.Add.toVector(), "Large floating action button")
    }
}
